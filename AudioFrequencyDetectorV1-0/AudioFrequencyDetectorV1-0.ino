...
/*
Ich habe diesen Code leicht für das Experiment überarbeitet. Damit der Code funktioniert muss eine ältere Verion der arduinoFFT Bibliothek verwendet werden. Ich nutze die Version 1.6.2
*/
#include "arduinoFFT.h"
 
#define SAMPLES 128             //SAMPLES-pt FFT. Must be a base 2 number. Max 128 for Arduino Uno.
#define SAMPLING_FREQUENCY 1500 //Ts = Based on Nyquist, must be 2 times the highest expected frequency.
...
{  
    ...
    while(1);/*Hier resetten, um die Messung zu vereinfachen*/
}
